...
uint8_t system_clock_config(void) {
    ...
    rcc_osc_init_struct.PLL.PLLQ = 8;
    ...
    rcc_periph_init_struct.PLL3.PLL3R = 13;
    ...
    /*## SDMMC clock configuration. #########################################*/
    rcc_periph_init_struct.PeriphClockSelection = RCC_PERIPHCLK_SDMMC;
    rcc_periph_init_struct.SdmmcClockSelection = RCC_SDMMCCLKSOURCE_PLL;
    res = HAL_RCCEx_PeriphCLKConfig(&rcc_periph_init_struct);
    if (res != HAL_OK) {
        return SYSTEM_PERIPH_CLK_FAIL;
    }

    /*## USB FS clock configuration. ########################################*/
    rcc_periph_init_struct.PeriphClockSelection = RCC_PERIPHCLK_USB;
    rcc_periph_init_struct.UsbClockSelection = RCC_USBCLKSOURCE_HSI48;
    res = HAL_RCCEx_PeriphCLKConfig(&rcc_periph_init_struct);
    if (res != HAL_OK) {
        return SYSTEM_PERIPH_CLK_FAIL;
    }
    ...
    rcc_periph_init_struct.PeriphClockSelection = RCC_PERIPHCLK_LTDC;
    ...
    rcc_periph_init_struct.PeriphClockSelection = RCC_PERIPHCLK_ADC;
    rcc_periph_init_struct.AdcClockSelection = RCC_ADCCLKSOURCE_PLL3;
    res = HAL_RCCEx_PeriphCLKConfig(&rcc_periph_init_struct);
    if (res != HAL_OK) {
        return SYSTEM_PERIPH_CLK_FAIL;
    }
