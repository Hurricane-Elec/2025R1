...
#    error "PA12 can not be configured as SPI2 SCK on STM32H755xx! "
#  endif  /* (defined(STM32H755xx)) */
#elif (SPI2_SCK_ID == 2)
#  define SPI2_SCK_GPIO_AF GPIO_AF5_SPI2
#  if (defined(STM32H757xx))
#    error "PB10 can not be configured as SPI2 SCK on STM32H757xx! "
#  endif  /* (defined(STM32H757xx)) */
#elif (SPI2_SCK_ID == 3)
#  define SPI2_SCK_GPIO_AF GPIO_AF5_SPI2
#  if (defined(STM32H757xx))
#    error "PB13 can not be configured as SPI2 SCK on STM32H757xx! "
#  endif  /* (defined(STM32H757xx)) */
#elif (SPI2_SCK_ID == 4)
#  define SPI2_SCK_GPIO_AF GPIO_AF5_SPI2
#elif (SPI2_SCK_ID == 5)
...
#    error "PI1 can not be configured as SPI2 SCK on STM32H735xx, STM32H730xxQ, STM32H725xx, STM32H733xx, STM32H730xx, STM32H723xx! "
...
#  define SPI2_MISO_GPIO_AF GPIO_AF5_SPI2
#  if (defined(STM32H735xx) || defined(STM32H730xxQ) || defined(STM32H725xx) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx))
#    error "PI2 can not be configured as SPI2 MISO on STM32H735xx, STM32H730xxQ, STM32H725xx, STM32H733xx, STM32H730xx, STM32H723xx! "
#  endif  /* (defined(STM32H735xx) || defined(STM32H730xxQ) || defined(STM32H725xx) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx)) */
#endif  /* SPI2_MISO_ID */
...
#  define SPI2_MOSI_GPIO_AF GPIO_AF5_SPI2
#  if (defined(STM32H735xx) || defined(STM32H730xxQ) || defined(STM32H725xx) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx))
#    error "PI3 can not be configured as SPI2 MOSI on STM32H735xx, STM32H730xxQ, STM32H725xx, STM32H733xx, STM32H730xx, STM32H723xx! "
#  endif  /* (defined(STM32H735xx) || defined(STM32H730xxQ) || defined(STM32H725xx) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx)) */
#endif  /* SPI2_MOSI_ID */
...
#  define SPI2_NSS_GPIO_AF GPIO_AF5_SPI2
#  if (defined(STM32H757xx))
#    error "PB9 can not be configured as SPI2 NSS on STM32H757xx! "
#  endif  /* (defined(STM32H757xx)) */
#elif (SPI2_NSS_ID == 4)
#  define SPI2_NSS_GPIO_AF GPIO_AF5_SPI2
#  if (defined(STM32H757xx))
#    error "PB12 can not be configured as SPI2 NSS on STM32H757xx! "
#  endif  /* (defined(STM32H757xx)) */
#elif (SPI2_NSS_ID == 5)
#  define SPI2_NSS_GPIO_AF GPIO_AF5_SPI2
#  if (defined(STM32H735xx) || defined(STM32H730xxQ) || defined(STM32H725xx) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx))
#    error "PI0 can not be configured as SPI2 NSS on STM32H735xx, STM32H730xxQ, STM32H725xx, STM32H733xx, STM32H730xx, STM32H723xx! "
#  endif  /* (defined(STM32H735xx) || defined(STM32H730xxQ) || defined(STM32H725xx) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx)) */
#endif  /* SPI2_NSS_ID */
...
#  define SPI4_MOSI_GPIO_AF GPIO_AF5_SPI4
#  if (defined(STM32H755xx))
#    error "PE14 can not be configured as SPI4 MOSI on STM32H755xx! "
#  endif  /* (defined(STM32H755xx)) */
#endif  /* SPI4_MOSI_ID */
...
#    error "PH6 can not be configured as SPI5 SCK on STM32H733xx, STM32H723xx! "
#  endif  /* (defined(STM32H733xx) || defined(STM32H723xx)) */
#elif (SPI5_SCK_ID == 2)
#  define SPI5_SCK_GPIO_AF GPIO_AF5_SPI5
#  if (defined(STM32H730xxQ) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx))
#    error "PK0 can not be configured as SPI5 SCK on STM32H730xxQ, STM32H733xx, STM32H730xx, STM32H723xx! "
#  endif  /* (defined(STM32H730xxQ) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx)) */
#endif  /* SPI5_SCK_ID */
...
#  define SPI5_MISO_GPIO_AF GPIO_AF5_SPI5
#  if (defined(STM32H733xx) || defined(STM32H723xx))
#    error "PH7 can not be configured as SPI5 MISO on STM32H733xx, STM32H723xx! "
#  endif  /* (defined(STM32H733xx) || defined(STM32H723xx)) */
#elif (SPI5_MISO_ID == 3)
#  define SPI5_MISO_GPIO_AF GPIO_AF5_SPI5
#  if (defined(STM32H733xx) || defined(STM32H723xx))
#    error "PJ11 can not be configured as SPI5 MISO on STM32H733xx, STM32H723xx! "
#  endif  /* (defined(STM32H733xx) || defined(STM32H723xx)) */
#endif  /* SPI5_MISO_ID */
...
#  define SPI5_MOSI_GPIO_AF GPIO_AF5_SPI5
#  if (defined(STM32H733xx) || defined(STM32H723xx))
#    error "PJ10 can not be configured as SPI5 MOSI on STM32H733xx, STM32H723xx! "
#  endif  /* (defined(STM32H733xx) || defined(STM32H723xx)) */
#endif  /* SPI5_MOSI_ID */
...
#  define SPI5_NSS_GPIO_AF GPIO_AF5_SPI5
#  if (defined(STM32H733xx) || defined(STM32H723xx))
#    error "PH5 can not be configured as SPI5 NSS on STM32H733xx, STM32H723xx! "
#  endif  /* (defined(STM32H733xx) || defined(STM32H723xx)) */
#elif (SPI5_NSS_ID == 3)
#  define SPI5_NSS_GPIO_AF GPIO_AF5_SPI5
#  if (defined(STM32H730xxQ) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx))
#    error "PK1 can not be configured as SPI5 NSS on STM32H730xxQ, STM32H733xx, STM32H730xx, STM32H723xx! "
#  endif  /* (defined(STM32H730xxQ) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx)) */
#endif  /* SPI5_NSS_ID */
...
#if (SPI6_SCK_ID == 0)
#  define SPI6_SCK_GPIO_AF GPIO_AF8_SPI6
#elif (SPI6_SCK_ID == 1)
#  define SPI6_SCK_GPIO_AF GPIO_AF8_SPI6
#elif (SPI6_SCK_ID == 2)
#  define SPI6_SCK_GPIO_AF GPIO_AF5_SPI6
#  if (defined(STM32H755xx))
#    error "PG13 can not be configured as SPI6 SCK on STM32H755xx! "
#  endif  /* (defined(STM32H755xx)) */
#elif (SPI6_SCK_ID == 3)
#  define SPI6_SCK_GPIO_AF GPIO_AF5_SPI6
#  if !(defined(STM32H735xx) || defined(STM32H725xx) || defined(STM32H730xxQ) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx))
#    error "PC12 only can be configured as SPI6 SCK on STM32H735xx, STM32H725xx, STM32H730xxQ, STM32H733xx, STM32H730xx, STM32H723xx! "
#  endif  /* !(defined(STM32H735xx) || defined(STM32H725xx) || defined(STM32H730xxQ) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx)) */
#endif  /* SPI6_SCK_ID */

#if (SPI6_MISO_ID == 0)
#elif (SPI6_MISO_ID == 1)
#  define SPI6_MISO_GPIO_AF GPIO_AF8_SPI6
#elif (SPI6_MISO_ID == 2)
#  define SPI6_MISO_GPIO_AF GPIO_AF8_SPI6
#elif (SPI6_MISO_ID == 3)
...
#if (SPI6_NSS_ID == 0)
#elif (SPI6_NSS_ID == 1)
#  define SPI6_NSS_GPIO_AF GPIO_AF8_SPI6
#elif (SPI6_NSS_ID == 2)
#  define SPI6_NSS_GPIO_AF GPIO_AF7_SPI6
#elif (SPI6_NSS_ID == 3)
#  define SPI6_NSS_GPIO_AF GPIO_AF5_SPI6
#elif (SPI6_NSS_ID == 4)
#  define SPI6_NSS_GPIO_AF GPIO_AF5_SPI6
#  if !(defined(STM32H735xx) || defined(STM32H725xx) || defined(STM32H730xxQ) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx))
#    error "PA0 only can be configured as SPI6 NSS on STM32H735xx, STM32H725xx, STM32H730xxQ, STM32H733xx, STM32H730xx, STM32H723xx! "
#  endif  /* !(defined(STM32H735xx) || defined(STM32H725xx) || defined(STM32H730xxQ) || defined(STM32H733xx) || defined(STM32H730xx) || defined(STM32H723xx)) */
#endif  /* SPI6_NSS_ID */
...
#    define SPI6_RX_DMA_IRQn                                                  \
      CSP_BDMA_CHANNEL_IRQn(SPI6_RX_BDMA_CHANNEL)
#    define SPI6_RX_DMA_IRQHandler                                             \
      CSP_BDMA_CHANNEL_IRQ(SPI6_RX_BDMA_CHANNEL)
#  endif /* SPI6_RX_DMA */

#  if SPI6_TX_DMA
#    define SPI6_TX_DMA_IRQn                                                  \
      CSP_BDMA_CHANNEL_IRQn(SPI6_TX_BDMA_CHANNEL)
#    define SPI6_TX_DMA_IRQHandler                                             \
      CSP_BDMA_CHANNEL_IRQ(SPI6_TX_BDMA_CHANNEL)
#  endif /* SPI6_TX_DMA */
...
uint8_t spi_change_speed(SPI_HandleTypeDef *hspi, uint32_t speed);
