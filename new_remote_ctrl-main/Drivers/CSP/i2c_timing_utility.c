...
static void I2C_Compute_PRESC_SCLDEL_SDADEL(uint32_t clock_src_freq,
    ...
    tafdel_min =
        (I2C_USE_ANALOG_FILTER == 1U) ? I2C_ANALOG_FILTER_DELAY_MIN : 0U;
    tafdel_max =
        (I2C_USE_ANALOG_FILTER == 1U) ? I2C_ANALOG_FILTER_DELAY_MAX : 0U;
            ...
            if (tscldel >= (uint32_t)tscldel_min) {
                for (sdadel = 0; sdadel < I2C_SDADEL_MAX; sdadel++) {
                    ...
                    if ((tsdadel >= (uint32_t)tsdadel_min) &&
                        ...
                        if (presc != prev_presc) {
                            I2c_valid_timing[I2c_valid_timing_nbr].presc =
                                presc;
                            I2c_valid_timing[I2c_valid_timing_nbr].tscldel =
                                scldel;
                            I2c_valid_timing[I2c_valid_timing_nbr].tsdadel =
                                sdadel;
                            prev_presc = presc;
