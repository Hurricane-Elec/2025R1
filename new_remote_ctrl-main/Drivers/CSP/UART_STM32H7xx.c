...
static DMA_HandleTypeDef lpuart1_dmarx_handle = {
    .Instance = CSP_BDMA_CHANNEL(LPUART1_RX_BDMA_CHANNEL),
    .Init = {.Request = BDMA_REQUEST_LPUART1_RX,
...
static DMA_HandleTypeDef lpuart1_dmatx_handle = {
    .Instance = CSP_BDMA_CHANNEL(LPUART1_TX_BDMA_CHANNEL),
    .Init = {.Request = BDMA_REQUEST_LPUART1_TX,
...
uint8_t lpuart1_init(uint32_t baud_rate) {
    ...
    HAL_NVIC_SetPriority(LPUART1_RX_DMA_IRQn, LPUART1_RX_DMA_IT_PRIORITY, LPUART1_RX_DMA_IT_SUB);
    ...
    HAL_NVIC_SetPriority(LPUART1_TX_DMA_IRQn, LPUART1_TX_DMA_IT_PRIORITY, LPUART1_TX_DMA_IT_SUB);
    ...
    HAL_UARTEx_SetTxFifoThreshold(&lpuart1_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&lpuart1_handle, UART_RXFIFO_THRESHOLD_1_8);
...
uint8_t usart1_init(uint32_t baud_rate) {
    ...
    HAL_UARTEx_SetTxFifoThreshold(&usart1_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&usart1_handle, UART_RXFIFO_THRESHOLD_1_8);
...
static DMA_HandleTypeDef usart2_dmarx_handle = {
    ...
    .Init = {.Request = DMA_REQUEST_USART2_RX,
             .Direction = DMA_PERIPH_TO_MEMORY,
             .MemDataAlignment = DMA_MDATAALIGN_BYTE,
             .MemInc = DMA_MINC_ENABLE,
             .Mode = DMA_CIRCULAR,
...
uint8_t usart2_init(uint32_t baud_rate) {
    ...
    HAL_UARTEx_SetTxFifoThreshold(&usart2_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&usart2_handle, UART_RXFIFO_THRESHOLD_1_8);
...
static DMA_HandleTypeDef usart3_dmarx_handle = {
    ...
    .Init = {.Request = DMA_REQUEST_USART3_RX,
             .Direction = DMA_PERIPH_TO_MEMORY,
             .MemDataAlignment = DMA_MDATAALIGN_BYTE,
             .MemInc = DMA_MINC_ENABLE,
             .Mode = DMA_CIRCULAR,
...
uint8_t usart3_init(uint32_t baud_rate) {
    ...
    HAL_UARTEx_SetTxFifoThreshold(&usart3_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&usart3_handle, UART_RXFIFO_THRESHOLD_1_8);
...
uint8_t uart4_init(uint32_t baud_rate) {
    ...
    HAL_UARTEx_SetTxFifoThreshold(&uart4_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&uart4_handle, UART_RXFIFO_THRESHOLD_1_8);
...
uint8_t uart5_init(uint32_t baud_rate) {
    ...
    HAL_UARTEx_SetTxFifoThreshold(&uart5_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&uart5_handle, UART_RXFIFO_THRESHOLD_1_8);
...
uint8_t usart6_init(uint32_t baud_rate) {
    ...
    HAL_UARTEx_SetTxFifoThreshold(&usart6_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&usart6_handle, UART_RXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_DisableFifoMode(&usart6_handle);
...
static DMA_HandleTypeDef uart7_dmarx_handle = {
    ...
    .Init = {.Request = DMA_REQUEST_UART7_RX,
             .Direction = DMA_PERIPH_TO_MEMORY,
             .MemDataAlignment = DMA_MDATAALIGN_BYTE,
             .MemInc = DMA_MINC_ENABLE,
             .Mode = DMA_CIRCULAR,
...
uint8_t uart7_init(uint32_t baud_rate) {
...
#if UART7_CTS
    uart7_handle.Init.HwFlowCtl |= UART_HWCONTROL_CTS;

    CSP_GPIO_CLK_ENABLE(UART7_CTS_PORT);
    gpio_init_struct.Pin = UART7_CTS_PIN;
    gpio_init_struct.Alternate = UART7_CTS_GPIO_AF;
    HAL_GPIO_Init(CSP_GPIO_PORT(UART7_CTS_PORT), &gpio_init_struct);
#endif /* UART7_UART7_CTS */

#if UART7_RTS
    uart7_handle.Init.HwFlowCtl |= UART_HWCONTROL_RTS;

    CSP_GPIO_CLK_ENABLE(UART7_RTS_PORT);
    gpio_init_struct.Pin = UART7_RTS_PIN;
    gpio_init_struct.Alternate = UART7_RTS_GPIO_AF;
    HAL_GPIO_Init(CSP_GPIO_PORT(UART7_RTS_PORT), &gpio_init_struct);
#endif /* UART7_RTS */
    ...
    HAL_UARTEx_SetTxFifoThreshold(&uart7_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&uart7_handle, UART_RXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_DisableFifoMode(&uart7_handle);
...
#if UART7_CTS
    HAL_GPIO_DeInit(CSP_GPIO_PORT(UART7_CTS_PORT), UART7_CTS_PIN);
#endif /* UART7_UART7_CTS */

#if UART7_RTS
    HAL_GPIO_DeInit(CSP_GPIO_PORT(UART7_RTS_PORT), UART7_RTS_PIN);
#endif /* UART7_RTS */
...
uint8_t uart8_init(uint32_t baud_rate) {
...
#if UART8_CTS
    uart8_handle.Init.HwFlowCtl |= UART_HWCONTROL_CTS;

    CSP_GPIO_CLK_ENABLE(UART8_CTS_PORT);
    gpio_init_struct.Pin = UART8_CTS_PIN;
    gpio_init_struct.Alternate = UART8_CTS_GPIO_AF;
    HAL_GPIO_Init(CSP_GPIO_PORT(UART8_CTS_PORT), &gpio_init_struct);
#endif /* UART8_UART8_CTS */

#if UART8_RTS
    uart8_handle.Init.HwFlowCtl |= UART_HWCONTROL_RTS;

    CSP_GPIO_CLK_ENABLE(UART8_RTS_PORT);
    gpio_init_struct.Pin = UART8_RTS_PIN;
    gpio_init_struct.Alternate = UART8_RTS_GPIO_AF;
    HAL_GPIO_Init(CSP_GPIO_PORT(UART8_RTS_PORT), &gpio_init_struct);
#endif /* UART8_RTS */
    ...
    HAL_UARTEx_SetTxFifoThreshold(&uart8_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&uart8_handle, UART_RXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_DisableFifoMode(&uart8_handle);
...
#if UART8_CTS
    HAL_GPIO_DeInit(CSP_GPIO_PORT(UART8_CTS_PORT), UART8_CTS_PIN);
#endif /* UART8_UART8_CTS */

#if UART8_RTS
    HAL_GPIO_DeInit(CSP_GPIO_PORT(UART8_RTS_PORT), UART8_RTS_PIN);
#endif /* UART8_RTS */
...
static DMA_HandleTypeDef uart9_dmarx_handle = {
    ...
    .Init = {.Request = DMA_REQUEST_UART9_RX,
             .Direction = DMA_PERIPH_TO_MEMORY,
             .MemDataAlignment = DMA_MDATAALIGN_BYTE,
             .MemInc = DMA_MINC_ENABLE,
             .Mode = DMA_CIRCULAR,
...
uint8_t uart9_init(uint32_t baud_rate) {
...
#if UART9_CTS
    uart9_handle.Init.HwFlowCtl |= UART_HWCONTROL_CTS;

    CSP_GPIO_CLK_ENABLE(UART9_CTS_PORT);
    gpio_init_struct.Pin = UART9_CTS_PIN;
    gpio_init_struct.Alternate = UART9_CTS_GPIO_AF;
    HAL_GPIO_Init(CSP_GPIO_PORT(UART9_CTS_PORT), &gpio_init_struct);
#endif /* UART9_UART9_CTS */

#if UART9_RTS
    uart9_handle.Init.HwFlowCtl |= UART_HWCONTROL_RTS;

    CSP_GPIO_CLK_ENABLE(UART9_RTS_PORT);
    gpio_init_struct.Pin = UART9_RTS_PIN;
    gpio_init_struct.Alternate = UART9_RTS_GPIO_AF;
    HAL_GPIO_Init(CSP_GPIO_PORT(UART9_RTS_PORT), &gpio_init_struct);
#endif /* UART9_RTS */
    ...
    HAL_UARTEx_SetTxFifoThreshold(&uart9_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&uart9_handle, UART_RXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_DisableFifoMode(&uart9_handle);
...
#if UART9_CTS
    HAL_GPIO_DeInit(CSP_GPIO_PORT(UART9_CTS_PORT), UART9_CTS_PIN);
#endif /* UART9_UART9_CTS */

#if UART9_RTS
    HAL_GPIO_DeInit(CSP_GPIO_PORT(UART9_RTS_PORT), UART9_RTS_PIN);
#endif /* UART9_RTS */
...
UART_HandleTypeDef usart10_handle = {.Instance = USART10,
                                    .Init = {.WordLength = UART_WORDLENGTH_8B,
                                             .StopBits = UART_STOPBITS_1,
                                             .Parity = UART_PARITY_NONE}};
...
static DMA_HandleTypeDef usart10_dmarx_handle = {
    .Instance = CSP_DMA_STREAM(USART10_RX_DMA_NUMBER, USART10_RX_DMA_STREAM),
    .Init = {.Request = DMA_REQUEST_USART10_RX,
             .Direction = DMA_PERIPH_TO_MEMORY,
             .MemDataAlignment = DMA_MDATAALIGN_BYTE,
             .MemInc = DMA_MINC_ENABLE,
             .Mode = DMA_CIRCULAR,
             .PeriphDataAlignment = DMA_PDATAALIGN_BYTE,
             .PeriphInc = DMA_PINC_DISABLE,
             .Priority = USART10_RX_DMA_PRIORITY}};

static uart_rx_fifo_t usart10_rx_fifo = {.buf_size = USART10_RX_DMA_BUF_SIZE,
                                        .fifo_size = USART10_RX_DMA_FIFO_SIZE};
...
static DMA_HandleTypeDef usart10_dmatx_handle = {
    ...
    .Init = {.Request = DMA_REQUEST_USART10_TX,
             ...
             .PeriphDataAlignment = DMA_PDATAALIGN_BYTE,
             .PeriphInc = DMA_PINC_DISABLE,
             .Priority = USART10_TX_DMA_PRIORITY}};

static uart_tx_buf_t usart10_tx_buf = {.buf_size = USART10_TX_DMA_BUF_SIZE};
...
uint8_t usart10_init(uint32_t baud_rate) {
    ...
    GPIO_InitTypeDef gpio_init_struct = {.Pull = GPIO_PULLUP,
                                         .Speed = GPIO_SPEED_FREQ_HIGH,
                                         .Mode = GPIO_MODE_AF_PP};
    usart10_handle.Init.BaudRate = baud_rate;
#if USART10_TX
    usart10_handle.Init.Mode |= UART_MODE_TX;

    CSP_GPIO_CLK_ENABLE(USART10_TX_PORT);
    gpio_init_struct.Pin = USART10_TX_PIN;
    gpio_init_struct.Alternate = USART10_TX_GPIO_AF;
    HAL_GPIO_Init(CSP_GPIO_PORT(USART10_TX_PORT), &gpio_init_struct);
#endif /* USART10_TX */

#if USART10_RX
    usart10_handle.Init.Mode |= UART_MODE_RX;

    CSP_GPIO_CLK_ENABLE(USART10_RX_PORT);
    gpio_init_struct.Pin = USART10_RX_PIN;
    gpio_init_struct.Alternate = USART10_RX_GPIO_AF;
    HAL_GPIO_Init(CSP_GPIO_PORT(USART10_RX_PORT), &gpio_init_struct);
#endif /* USART10_RX */

#if USART10_CTS
    usart10_handle.Init.HwFlowCtl |= UART_HWCONTROL_CTS;

    CSP_GPIO_CLK_ENABLE(USART10_CTS_PORT);
    gpio_init_struct.Pin = USART10_CTS_PIN;
    gpio_init_struct.Alternate = USART10_CTS_GPIO_AF;
    HAL_GPIO_Init(CSP_GPIO_PORT(USART10_CTS_PORT), &gpio_init_struct);
#endif /* USART10_USART10_CTS */

#if USART10_RTS
    usart10_handle.Init.HwFlowCtl |= UART_HWCONTROL_RTS;

    CSP_GPIO_CLK_ENABLE(USART10_RTS_PORT);
    gpio_init_struct.Pin = USART10_RTS_PIN;
    gpio_init_struct.Alternate = USART10_RTS_GPIO_AF;
    HAL_GPIO_Init(CSP_GPIO_PORT(USART10_RTS_PORT), &gpio_init_struct);
#endif /* USART10_RTS */

    __HAL_RCC_USART10_CLK_ENABLE();
#if USART10_IT_ENABLE
    HAL_NVIC_EnableIRQ(USART10_IRQn);
    HAL_NVIC_SetPriority(USART10_IRQn, USART10_IT_PRIORITY, USART10_IT_SUB);
#endif /* USART10_IT_ENABLE */

#if USART10_RX_DMA
    usart10_rx_fifo.head_ptr = 0;

    usart10_rx_fifo.recv_buf = CSP_MALLOC(usart10_rx_fifo.buf_size);
    if (usart10_rx_fifo.recv_buf == NULL) {
        return UART_INIT_MEM_FAIL;
    }

    usart10_rx_fifo.rx_fifo_buf = CSP_MALLOC(usart10_rx_fifo.fifo_size);
    if (usart10_rx_fifo.rx_fifo_buf == NULL) {
        return UART_INIT_MEM_FAIL;
    }

    usart10_rx_fifo.rx_fifo = ring_fifo_init(
        usart10_rx_fifo.rx_fifo_buf, usart10_rx_fifo.fifo_size, RF_TYPE_STREAM);
    ...
    __HAL_LINKDMA(&usart10_handle, hdmarx, usart10_dmarx_handle);

    HAL_NVIC_SetPriority(USART10_RX_DMA_IRQn, USART10_RX_DMA_IT_PRIORITY, USART10_RX_DMA_IT_SUB);
    HAL_NVIC_EnableIRQ(USART10_RX_DMA_IRQn);

#endif /* USART10_RX_DMA */

#if USART10_TX_DMA
    usart10_tx_buf.send_buf = CSP_MALLOC(usart10_tx_buf.buf_size);
    if (usart10_tx_buf.send_buf == NULL) {
        return UART_INIT_MEM_FAIL;
    }
    ...
    __HAL_LINKDMA(&usart10_handle, hdmatx, usart10_dmatx_handle);

    HAL_NVIC_SetPriority(USART10_TX_DMA_IRQn, USART10_TX_DMA_IT_PRIORITY, USART10_TX_DMA_IT_SUB);
    HAL_NVIC_EnableIRQ(USART10_TX_DMA_IRQn);

#endif /* USART10_TX_DMA */

    if (HAL_UART_Init(&usart10_handle) != HAL_OK) {
        return UART_INIT_FAIL;
    }

    HAL_UARTEx_SetTxFifoThreshold(&usart10_handle, UART_TXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_SetRxFifoThreshold(&usart10_handle, UART_RXFIFO_THRESHOLD_1_8);
    HAL_UARTEx_DisableFifoMode(&usart10_handle);

#if USART10_RX_DMA
    __HAL_UART_ENABLE_IT(&usart10_handle, UART_IT_IDLE);
    __HAL_UART_CLEAR_IDLEFLAG(&usart10_handle);

    HAL_UART_Receive_DMA(&usart10_handle, usart10_rx_fifo.recv_buf,
                         usart10_rx_fifo.buf_size);

#if USE_HAL_UART_REGISTER_CALLBACKS
    HAL_UART_RegisterCallback(&usart10_handle, HAL_UART_RX_HALFCOMPLETE_CB_ID,
                              uart_dmarx_halfdone_callback);
    HAL_UART_RegisterCallback(&usart10_handle, HAL_UART_RX_COMPLETE_CB_ID,
                              uart_dmarx_done_callback);
#endif /* USE_HAL_UART_REGISTER_CALLBACKS */
#endif /* USART10_RX_DMA */
    return UART_INIT_OK;
...
void USART10_IRQHandler(void) {
    if (__HAL_UART_GET_FLAG(&usart10_handle, UART_FLAG_IDLE)) {
        __HAL_UART_CLEAR_IDLEFLAG(&usart10_handle);
        uart_dmarx_idle_callback(&usart10_handle);
    }

    HAL_UART_IRQHandler(&usart10_handle);
}
...
/**
 * @brief USART10 Rx DMA ISR
 *
 */
void USART10_RX_DMA_IRQHandler(void) {
    HAL_DMA_IRQHandler(&usart10_dmarx_handle);
}
 ...
 *
 */
void USART10_TX_DMA_IRQHandler(void) {
    HAL_DMA_IRQHandler(&usart10_dmatx_handle);
}
...
uint8_t usart10_deinit(void) {
...
#if USART10_TX
    HAL_GPIO_DeInit(CSP_GPIO_PORT(USART10_TX_PORT), USART10_TX_PIN);
#endif /* USART10_TX */

#if USART10_RX
    HAL_GPIO_DeInit(CSP_GPIO_PORT(USART10_RX_PORT), USART10_RX_PIN);
#endif /* USART10_RX */

#if USART10_CTS
    HAL_GPIO_DeInit(CSP_GPIO_PORT(USART10_CTS_PORT), USART10_CTS_PIN);
#endif /* USART10_USART10_CTS */

#if USART10_RTS
    HAL_GPIO_DeInit(CSP_GPIO_PORT(USART10_RTS_PORT), USART10_RTS_PIN);
#endif /* USART10_RTS */
    ...
    HAL_DMA_Abort(&usart10_dmarx_handle);
    CSP_FREE(usart10_rx_fifo.recv_buf);
    CSP_FREE(usart10_rx_fifo.rx_fifo_buf);
    ring_fifo_destroy(usart10_rx_fifo.rx_fifo);

    if (HAL_DMA_DeInit(&usart10_dmarx_handle) != HAL_OK) {
        return UART_DEINIT_DMA_FAIL;
    }

    HAL_NVIC_DisableIRQ(USART10_RX_DMA_IRQn);

#if USE_HAL_UART_REGISTER_CALLBACKS
    HAL_UART_UnRegisterCallback(&usart10_handle, HAL_UART_RX_HALFCOMPLETE_CB_ID);
    HAL_UART_UnRegisterCallback(&usart10_handle, HAL_UART_RX_COMPLETE_CB_ID);
#endif /* USE_HAL_UART_REGISTER_CALLBACKS */
    usart10_handle.hdmarx = NULL;

#endif /* USART10_RX_DMA */

#if USART10_TX_DMA
    HAL_DMA_Abort(&usart10_dmatx_handle);
    CSP_FREE(usart10_tx_buf.send_buf);

    if (HAL_DMA_DeInit(&usart10_dmatx_handle) != HAL_OK) {
        return UART_DEINIT_DMA_FAIL;
    }

    HAL_NVIC_DisableIRQ(USART10_TX_DMA_IRQn);

    usart10_handle.hdmatx = NULL;
#endif /* USART10_TX_DMA */

    if (HAL_UART_DeInit(&usart10_handle) != HAL_OK) {
        return UART_DEINIT_FAIL;
    }
