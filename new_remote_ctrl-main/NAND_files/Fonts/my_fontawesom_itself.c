 ...
 * Size: 30 px
 * Bpp: 4
 * Opts: --bpp 4 --size 30 --no-compress --font FontAwesome5-Solid+Brands+Regular.woff --range 61447 --format lvgl -o my_fontawesom_itself.c
 ******************************************************************************/
...
#ifndef MY_FONTAWESOM_ITSELF
#define MY_FONTAWESOM_ITSELF 1
#endif

#if MY_FONTAWESOM_ITSELF
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x96, 0x44, 0x68, 0xdf, 0xff, 0xd8, 0x10, 0x0,
    ...
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xd0, 0x9, 0xef, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xfe, 0xb2, 0x0
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t my_fontawesom_itself = {
#else
lv_font_t my_fontawesom_itself = {
#endif
