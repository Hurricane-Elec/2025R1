...
#define USBD_PRODUCT_HS_STRING        "STM32 in HS Mode"
#define USBD_PRODUCT_FS_STRING        "STM32 in FS Mode"
#define USBD_CONFIGURATION_HS_STRING  "STM32 USB HS Config"
#define USBD_INTERFACE_HS_STRING      "STM32 USB HS Interface"
#define USBD_CONFIGURATION_FS_STRING  "STM32 USB FS Config"
#define USBD_INTERFACE_FS_STRING      "STM32 USB FS Interface"
